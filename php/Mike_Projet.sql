...
CREATE TABLE IF NOT EXISTS `mydb`.`employe` (
  ...
  INDEX `fk_employe_categorie_idx` (`categorie_idcategorie` ASC),
  INDEX `fk_employe_fonction1_idx` (`fonction_idfonction` ASC),
  CONSTRAINT `fk_employe_categorie`
    FOREIGN KEY (`categorie_idcategorie`)
    REFERENCES `mydb`.`categorie` (`idcategorie`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_employe_fonction1`
